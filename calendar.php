...
var nMonth= new Array('正','二','三','四','五','六','七','八','九','十','冬','腊');
...
lObj.innerHTML = '<b>'+(cld[sD].isLeap?'闰':'') + nMonth[cld[sD].lMonth-1] + '月' + (monthDays(cld[sD].lYear,cld[sD].lMonth)==29?'小':'大')+'</b>';
else //显示农历日
lObj.innerHTML = cDay(cld[sD].lDay);

GZ.innerHTML = '农历' + cyclical(SY-1900+36) + Animals[(SY-4)%12] + '年' + nMonth[cld[sD].lMonth-1] + '月';
